...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['role:dokter'])->prefix('dokter')->group(function () {
        ...
        Route::prefix('obat')->group(function () {
            ...
            Route::get('/indexDeleted', [ObatController::class, 'indexDeleted'])->name('dokter.obat.indexDeleted');
        ...
        Route::prefix('profile')->group(function (){
            ...
            Route::match(['patch', 'put'], '/', [ProfileController::class, 'update'])->name('dokter.profile.update');
